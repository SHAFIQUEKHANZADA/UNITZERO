    ...
    <div className="min-h-screen bg-omniv-dark text-white">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="max-w-6xl mx-auto text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-omniv-card/50 backdrop-blur-sm border border-omniv-primary/30 mb-8">
              <Star className="w-5 h-5 text-omniv-primary" />
              <span className="text-omniv-primary font-medium">Our Story</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <h3 className="text-2xl font-semibold text-omniv-secondary mb-4">The Story of UnitZero</h3>
                <p className="text-lg leading-relaxed text-omniv-muted mb-6">
                ...
                <h4 className="text-xl font-semibold text-white mb-4">The Meaning of UnitZero</h4>
                <p className="text-lg leading-relaxed text-omniv-muted">
            ...
            <div className="relative">
              <div className="relative bg-gradient-to-br from-omniv-primary/20 to-omniv-secondary/20 rounded-3xl p-8 border border-omniv-primary/30">
                <div className="bg-omniv-card/80 backdrop-blur-sm rounded-2xl p-8 text-center">
                  <div className="w-20 h-20 bg-omniv-primary/20 rounded-full mx-auto mb-6 flex items-center justify-center">
                    <Target className="w-10 h-10 text-omniv-primary" />
                  </div>
                  <h4 className="text-2xl font-bold text-white mb-4">Customer-Centric Approach</h4>
                  <p className="text-omniv-muted leading-relaxed">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-omniv-secondary/30 rounded-full animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-omniv-primary/30 rounded-full animate-pulse delay-1000"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="group text-center p-8 bg-omniv-card/50 backdrop-blur-sm rounded-2xl border border-omniv hover:border-omniv-primary/30 transition-all duration-500 hover:scale-105"
              >
                <div className="w-16 h-16 bg-gradient-to-br from-omniv-primary/20 to-omniv-secondary/20 rounded-2xl mx-auto mb-6 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <value.icon className="w-8 h-8 text-omniv-primary" />
                </div>
                <h3 className="text-xl font-bold text-white mb-4">{value.title}</h3>
                <p className="text-omniv-muted leading-relaxed">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative z-10 container mx-auto px-6 pb-20">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
            {/* Vision */}
            <div className="bg-gradient-to-br from-omniv-primary/10 to-omniv-secondary/10 rounded-3xl p-8 border border-omniv-primary/20">
            ...
            {/* Commitment */}
            <div className="bg-gradient-to-br from-omniv-secondary/10 to-omniv-primary/10 rounded-3xl p-8 border border-omniv-secondary/20">
      ...
      <section className="relative z-10 container mx-auto px-6 pb-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-omniv-primary via-omniv-secondary to-omniv-primary transform -translate-x-1/2"></div>
              ...
              {[
                ...
                <div key={index} className={`relative flex items-center ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                  ...
                  <div className={`w-5/12 ${index % 2 === 0 ? 'text-right pr-8' : 'text-left pl-8'}`}>
                    <div className="bg-omniv-card/50 backdrop-blur-sm rounded-2xl p-6 border border-omniv hover:border-omniv-primary/30 transition-all duration-300">
                      <div className="text-2xl font-bold text-omniv-primary mb-2">{milestone.year}</div>
                      <h3 className="text-xl font-bold text-white mb-3">{milestone.title}</h3>
                      <p className="text-omniv-muted">{milestone.description}</p>
                    </div>
                  </div>
                </div>
              ))}
