            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-left space-y-8 max-w-2xl animate-fade-in-up">
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-3 text-sm font-medium text-omniv-muted">
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-8 pt-8">
                            {[
                                ...
                                >
                                    <div className={`text-3xl font-bold text-white group-hover:text-${stat.color} transition-colors duration-300`}>
                                        {stat.number}
                                    </div>
                                    <div className="text-sm text-omniv-muted group-hover:text-white transition-colors duration-300">
                                        {stat.label}
                                    </div>
                                </div>
                            ))}
