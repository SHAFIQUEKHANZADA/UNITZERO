                ...
                <div className="flex gap-12 items-start">
                    ...
                    <div className="w-1/2 sticky top-24">
                        <div className="relative">
                            ...
                            <div
                                className={`absolute inset-0 bg-gradient-to-r ${services[activeSection].color} rounded-2xl opacity-20 blur-xl transform scale-110 transition-all duration-700`}
                            ></div>
                            ...
                            >
                                ...
                                <div className="space-y-6">
                                    {service.features.map((feature, featureIndex) => (
                                        <div
                                            key={featureIndex}
                                            className={`bg-white rounded-xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105 ${index === activeSection ? "animate-fade-in-up" : ""
                                                }`}
