...
const MobileMenuBar = () => {
    ...
    return (
        <div className="md:hidden">
            ...
            {/* Main Menu Drawer */}
            {isMenuOpen && (
                <div className="fixed inset-0 z-50 h-[95%] w-full mt-20 text-black">
                    <div
                        className={`relative w-full bg-white p-4 h-full flex flex-col items-start overflow-hidden transition-transform duration-500 ${activeSubMenu ? "-translate-x-full" : "translate-x-0"
                            }`}
                    >
                        {/* Main Menu */}
                        <div
                    ...
                    >
                        ...
                        {activeSubMenu === "ABOUT_ROBIZ" && (
                            <>
                                <h1 className="py-4 text-[19px] font-semibold uppercase">ABOUT UNITZERO</h1>
                                <div className="w-full h-[0.1px] bg-[#7B7B7B] my-2"></div>
